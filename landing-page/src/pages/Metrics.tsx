          ...
          <div className="grid md:grid-cols-4 gap-4">
            {[
              ...
              <Card key={step.num} className="p-4">
                <div className={`w-10 h-10 bg-${step.color}-100 rounded-full flex items-center justify-center mb-3`}>
        ...
        <section className="container pb-16">
          <Card className="p-8 md:p-12 text-center bg-gradient-to-br from-primary/5 to-purple-600/5">
            ...
            <Button size="lg" asChild>
              <a href={import.meta.env.VITE_FRONTEND_URL || "http://localhost:3000"}>
